...
public class Point implements Comparable<Point> {
     ...
     * If two slopes are same, compare the two points
     *
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point x1 = new Point(303, 124);
        Point [] x2 = new Point[2];
        x2[0] = new Point(13, 64);
        x2[1] = new Point(13, 64);
        System.out.println(x1.slopeOrder().compare(x2[0], x2[1]));
    }
}
